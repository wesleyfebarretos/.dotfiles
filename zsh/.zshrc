...
export PATH="$HOME/usr/bin:$HOME/go/bin:$PATH:/usr/local/go/bin:$HOME/apache-maven-3.9.6/bin:$HOME/.local/bin:/opt/docker-desktop/bin:$HOME/.local/scripts:$HOME/.cargo/bin"
